...
$setglobal prodEolien_csv Données_8760periods - Eolien - export_gams.csv
...
Parameter demnet_WOhydro(t);
LOOP(t, demnet_WOhydro(t) =
  demelec(t)
*- bess(t)
*+ achat(t)
);
...
demand(t).. sum(iunit, PUISS(iunit,t)) =g= demnet(t) ;
...
* Itérer sur les périodes et écrire les valeurs marginales
loop(t,
    put ord(t):0:0, put demelec(t):10:3, put puiss.l('PVP', t):10:3, put puiss.l('WPO', t):10:3/; 
);
putclose prodValues;
...
* Itérer sur les périodes et écrire les valeurs marginales
loop(t,
    put ord(t):0:0,put demelec(t), put demnet_WOhydro(t) /; 
);
putclose results;
